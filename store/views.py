...
def store_view(request):
    ...
    if request.GET:
        ...
        if "manufacturer" in request.GET:
            ...
            products = products.filter(manufacturer__manu_nospaces__in=manufacturer)
        ...
        if "cpu" in request.GET:
            ...
            products = products.filter(cpu__cpu_nospaces__in=cpu)
...
def edit_product(request, product_id):
    ...
    if request.method == "POST":
        ...
        # when Django handles a file upload,
        # the file data ends up placed in request.FILES
